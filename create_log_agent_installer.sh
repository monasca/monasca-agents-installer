...
${LOG_AGENT_TMP_DIR}/logstash-${LOGSTASH_VERSION}/bin/logstash-plugin install ${TMP_DIR}/logstash-output-monasca_log_api-${LOGSTASH_OUTPUT_MONASCA_LOG_API_VERSION}.gem
